...
class PitSettingsWidget(ttk.Frame):
    ...
    def __init__(self, parent, settings):
        ...
        # Variables
        self.remote_control_var = tk.BooleanVar(value=settings.get("remote_pit_control_enabled", False))
        self.fuel_var = tk.BooleanVar(value=settings.get("fuel_management_enabled", False))
        self.tyre_swap_var = tk.BooleanVar(value=settings.get("tyre_swap_enabled", False))
        self.tyre_compound_var = tk.BooleanVar(value=settings.get("tyre_compound_enabled", False))
...
def get_pit_settings_tab(notebook):
    ...
    title_label = ttk.Label(
        main_container, 
        text="Pit Stop Control Settings", 
    ...
    def reset_defaults():
        ...
        if result:
            ...
            pit_widget.remote_control_var.set(DEFAULT_SETTINGS["remote_pit_control_enabled"])
